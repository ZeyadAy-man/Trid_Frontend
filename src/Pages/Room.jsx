              ...
              <Suspense fallback={<Loader/>}>
                <Physics allowSleep={false} iterations={15} gravity={[0, -200, 0]}>
                  ...
                  {(shopUrl && shopCoordinates) ? <SolidGLTFModel
                    ...
                    position={[shopCoordinates.x_pos, shopCoordinates.y_pos - 13, shopCoordinates.z_pos]}
                  /> : null}
                  {(signCoordinates && signUrl) ? <SolidGLTFModel
                    ...
                    position={[signCoordinates.x_pos, signCoordinates.y_pos - 7, signCoordinates.z_pos]}
                  /> : null}
                  {(doorCoordinates && doorUrl) ? <SolidGLTFModel
                    url={doorUrl}
                    scale={[doorCoordinates.x_scale, doorCoordinates.y_scale, doorCoordinates.z_scale]}
                    position={[doorCoordinates.x_pos, doorCoordinates.y_pos - 7, doorCoordinates.z_pos]}
                  /> : null}
