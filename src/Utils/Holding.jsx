...
function Scene({ isNotInRT = false }) {
  ...
  light.intensity = 5
  // import '../public/'
// import '../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesA/scene.gltf'
//i should apply any model!
// import
  const sunGeometry = (useGLTF('sun.glb').scene.children[0]).geometry
  console.log(sunGeometry);
...
function vibrateOnEvent(e) {
  // console.log(e.pointerState.controller);
