...
const SHOES_CONFIGURATIONS = [
  {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes1/scene.glb',
        position: [1.5, 1.08, 2.3],
        rotation: [0, Math.PI, 0],
        scale: [0.08, 0.08, 0.08]
    },
    {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes2/scene.glb',
        position: [1.55, 1.66, 2.3],
        rotation: [0, Math.PI, 0],
        scale: [0.08, 0.08, 0.08]
    },
    {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes3/scene.glb',
        position: [2.648, 1.65, 2.3],
        rotation: [0, Math.PI, 0],
        scale: [0.08, 0.08, 0.08]
    },
    {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes4/scene.glb',
    ...
    // GG
    {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes9/scene.glb',
    ...
    // nike white
    {
        path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/Shoes7/scene.glb',
        position: [2.65, 0.676, 2.2],
        rotation: [0, Math.PI/2, 0],
        scale: [0.015, 0.015, 0.015]
    },
    { //nike blue
      path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesB/scene.glb',
      position: [-3, 0.72, 1],
      rotation: [0, Math.PI, 0],
      scale: [0.08, 0.08, 0.08]
  },
  { // nike gray
    path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesC/scene.glb',
    position: [0.39, 1.23, 2.35],
    rotation: [0, Math.PI/-2, 0],
    scale: [0.3, 0.23, 0.23]
},
{ // nike gray 2
  path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesD/scene.glb',
  position: [0.39, 1.69, 2.35],
    rotation: [0, Math.PI, 0],
    scale: [1, 1, 1]
},
{ // nike gray 2
  path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesE/scene.glb',
  position: [-0.72, 1.68, 2.35],
    rotation: [0, Math.PI, 0],
    scale: [1.5, 1.5, 1.5]
},
{ // Dior
  path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesH/scene.glb',
  position: [-0.72, 1.13, 2.35],
    rotation: [0, 0, 0],
    scale: [0.35, 0.35, 0.35]
},
{ // nb gray
  path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesI/scene.glb',
  position: [-0.72, 0.72, 2.35],
    rotation: [0, Math.PI/2, 0],
    scale: [0.076, 0.076, 0.076]
},
{ // white & blue
  path: '../../Assets/3D_Models/ShoesShop/DynamicObjects/ShoesK/scene.glb',
